...
const INVITATION = {
  couple: {
    bride: "සචිනි",
    groom: "කසුන්",
    brideFull: "සචිනි නෙත්මි දිසානායක",
    groomFull: "කසුන් තරංග බණ්ඩාර",
  },
  date: {
    displayNumeric: "19 . 03 . 2027",
    displayLong: "වර්ෂ 2027 ක් වූ මාර්තු මස 19 වන දින",
    countdownTarget: "2027-03-19T10:10:00+05:30",
  },
  time: {
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center z-[120] bg-black/40 backdrop-blur-[2px]">
                ...
                >
                  <motion.div
                    ...
                    className="mb-12"
                  >
                    <h2 className="text-4xl md:text-6xl text-[#4a5741] mb-2 drop-shadow-[0_2px_10px_rgba(255,255,255,0.8)]">
                      විවාහ ආරාධනයයි
                    </h2>
                    <p className="text-xl md:text-2xl text-[#4a5741] tracking-[0.3em] drop-shadow-[0_2px_10px_rgba(255,255,255,0.8)]">
                  ...
                  <motion.div
                    ...
                    className="mt-8 text-[#4a5741]/80 text-xs tracking-[0.35em]"
                  >
              ...
              <>
                ...
                >
                  <motion.h2
                    ...
                    className="text-3xl md:text-7xl text-[#4a5741] mb-8 drop-shadow-[0_2px_10px_rgba(255,255,255,0.8)]"
                  >
                    විවාහ ආරාධනයයි!
                  </motion.h2>
                  ...
                  <div className="flex flex-col items-center w-full max-w-[280px] mx-auto">
                    <motion.p
                      ...
                      className="text-3xl md:text-6xl text-[#4a5741] tracking-[0.3em] font-bold drop-shadow-[0_2px_10px_rgba(255,255,255,0.8)] self-start"
                    >
                    ...
                    <motion.span
                      ...
                      className="text-2xl md:text-4xl text-[#4a5741]/90 italic drop-shadow-[0_2px_10px_rgba(255,255,255,0.8)] my-1"
                    >
                      &
                    </motion.span>
                    ...
                    <motion.p
                      ...
                      className="text-3xl md:text-6xl text-[#4a5741] tracking-[0.4em] font-bold drop-shadow-[0_2px_10px_rgba(255,255,255,0.8)] self-end"
                    >
              ...
              <div className="relative z-10 w-full max-w-5xl px-6 text-center mt-12 md:mt-0">
                {guestName && (
                  <motion.p
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="text-lg md:text-xl font-bold text-[#4a5741] mb-2 drop-shadow-[0_0_10px_rgba(255,255,255,0.8)]"
                  >
                    {guestName}
                  </motion.p>
                )}
                ...
                >
                  ...
                  <div className="mt-6 flex items-center justify-center gap-5">
                    ...
                    <span className="text-4xl md:text-5xl text-[#4a5741] drop-shadow-[0_0_8px_rgba(255,255,255,0.8)] font-bold">සහ</span>
                    <div className="h-px w-14 bg-[#4a5741]/40" />
                  </div>
            ...
            >
              ...
              <div className="max-w-[1100px] w-full flex flex-col items-center text-center relative z-20 px-6">
                ...
                >
                  ...
                  <div className="text-[#4a5741] space-y-6 max-w-3xl mx-auto leading-relaxed text-base md:text-lg">
                    <p className="text-slate-700">
                      ජයන්ත දිසානායක මහතාගේ සහ චන්ද්‍රා දිසානායක මහත්මියගේ ආදරණීය දියණිය වන
                    </p>
                    <h3 className="text-3xl md:text-4xl font-bold text-[#b7563c] my-2">
                      {INVITATION.couple.brideFull}
                    </h3>

                    <p className="text-slate-700">
                      සෙනරත් බණ්ඩාර මහතාගේ සහ මාලිනී කුමාරිහාමි මහත්මියගේ ආදරණීය පුත් වන
                    </p>
                    <h3 className="text-3xl md:text-4xl font-bold text-[#b7563c] my-2">
                ...
                >
                  <div className="relative z-10 flex flex-col items-center">
                    ...
                    <h2 className="text-3xl md:text-6xl text-white tracking-[0.25em] md:tracking-[0.4em] font-bold leading-tight">
                      මෙම දිනය <span className="mx-2 md:mx-4 text-[#f2dfd3]">සුරකින්න</span>
                    </h2>
              ...
              <div className="container mx-auto px-6 max-w-5xl text-center">
                ...
                >
                  ...
                  <p className="text-sm md:text-base tracking-[0.5em] text-[#4a5741]/50 font-bold pt-12">
                    © 2027 {INVITATION.couple.bride} සහ {INVITATION.couple.groom}
                  </p>
                </motion.div>
              </div>
            </section>
